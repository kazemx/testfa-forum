...
const CategoryList = ({
  ...
  return <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 w-64">
      ...
      <div className="space-y-2 bg-teal-50">
        ...
        scale: 1.02
      }} className={`flex justify-between items-center p-2 hover:bg-white/30 rounded-md cursor-pointer transition-colors ${selectedCategory === category.name ? 'bg-white/30' : ''}`} onClick={() => onSelectCategory(category.name)}>
